...
- nginx has a separate `snz-rodoved-test.conf` for Host `test.snz-rodoved.ru`; DNS for the test subdomain still needs to be added before the normal public URL and HTTPS work.
