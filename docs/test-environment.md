...
- unfinished paper entry is restored for up to 24 hours in the same tab. Only the date, demographics, Q4-Q16, Q11 war detail, and current mobile step are stored; contacts, search context, free text, and workflow fields are omitted. Saving a row or completing the series clears the draft;
