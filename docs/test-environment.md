...
- Q16 `yes` reveals required name/phone and optional territory/period/free-text fields; changing Q16 to another answer clears only those dependent values. Invitation consent is a separate optional answer from the original paper form and remains independent from Q16. Public phone input accepts familiar formatting but requires 10-15 digits;
